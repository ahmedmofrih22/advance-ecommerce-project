    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
          ...
          <!-- ================================== TOP NAVIGATION ================================== -->
         @include('frontend.commons.vetical_menu');
          <!-- ================================== TOP NAVIGATION : END ================================== -->

          <!-- ============================================== HOT DEALS ============================================== -->
     @include('frontend.commons.hot_deals')
          <!-- ============================================== HOT DEALS: END ============================================== -->
...
@foreach (  $special_offer as $Product )
          ...
          <!-- ============================================== SPECIAL OFFER : END ============================================== -->
          <!-- ============================================== PRODUCT TAGS ============================================== -->
        @include('frontend.commons.product_tags')
          <!-- ============================================== PRODUCT TAGS : END ============================================== -->
          <!-- ============================================== SPECIAL DEALS ============================================== -->
          ...
          <!-- ============================================== Testimonials============================================== -->
          @include('frontend.commons.testimonials')
            ...
            <div class="more-info-tab clearfix ">
              ...
              <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                ...
                <li class="active"><a data-transition-type="backSlide" href="#all" data-toggle="tab">
                    ...
                    @if(session()->get('language') == 'english')  All
                    @else
                    الجميع
                    @endif
                </a></li>
                ...
                <li><a data-transition-type="backSlide" href="#category{{$catrgor->id}}" data-toggle="tab">

                    @if(session()->get('language') == 'english')  {{$catrgor->category_name_en}}
                    @else    {{$catrgor->category_name_ar}}
                    @endif
                </a></li>
                @endforeach
              </ul>
...
@endif
                          ...
                          <div class="product-info text-left">
                            <h3 class="name"><a href="{{url('Product/details/'.$Product->id. '/'.$Product->product_slug_en)}}">
                                @if(session()->get('language') == 'english') {{$Product ->product_name_en}}
                                @else   {{$Product ->product_name_ar}}
                                @endif
                            </a></h3>
                            <div class="rating rateit-small"></div>
        ...
        <button class="btn btn-primary icon" type="button" title="Wishlist" id="{{ $Product->id }}" onclick="addToWishList(this.id)"> <i class="fa fa-heart"></i> </button>
              ...
              @foreach ( $catrgors as   $catrgor)
              <div class="tab-pane " id="category{{$catrgor->id}}">
                <div class="product-slider">
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
@php
    $catwiseProduct = App\Models\Product::where('category_id',$catrgor->id)->orderBy('id','DESC')->get();
@endphp
...
@endif
 ...
 color: aliceblue;">NO Product Found</h5>

                    @endforelse   {{-- end forelse product --}}
                ...
                <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image">
                            <a href="{{url('Product/details/'.$Product->id. '/'.$Product->product_slug_en)}}"><img  src="{{ asset( $Product->product_thambnail) }}" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              <li class="add-cart-button btn-group">
                                <button data-toggle="modal" data-target="#exampleModal" onclick="ProductView(this.id)" id="{{$Product->id}}" class="btn btn-primary icon" type="button" title="Add Cart"> <i class="fa fa-shopping-cart"></i> </button>
                                <button class="btn btn-primary cart-btn" type="button">Add to cart</button>
                              </li>

                                <button  onclick="addToWishlist(this.id)" id="{{$Product->id}}" class="btn btn-primary icon" type="button" title="wishlist"> <i class="fa fa-heart"></i> </button>
 ...
 <section class="section featured-product wow fadeInUp">
    <h3 class="section-title">
        @if(session()->get('language') == 'english') {{ $skip_category_0->category_name_en}}
        @else   {{ $skip_category_0->category_name_ar}}
        @endif
    </h3>
    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
@endif
  ...
  <!-- /.section -->
  <!-- ============================================== skip_category_0 PRODUCTS : END 2 ============================================== -->
 ...
 <section class="section featured-product wow fadeInUp">
    <h3 class="section-title">
        @if(session()->get('language') == 'english') {{ $skip_category_1->category_name_en}}
        @else   {{ $skip_category_1->category_name_ar}}
        @endif
    </h3>
    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
@endif
  ...
  <!-- /.section -->
  <!-- ============================================== skip_category_1 PRODUCTS : END 2 ============================================== -->
 ...
 <section class="section featured-product wow fadeInUp">
    <h3 class="section-title">
        @if(session()->get('language') == 'english') {{ $skip_brand_1->brand_name_en}}
        @else   {{ $skip_brand_1->brand_name_ar}}
        @endif
    </h3>
    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
@endif
  ...
  <!-- /.section -->
  <!-- ============================================== skip_brand_product_1 PRODUCTS : END 2 ============================================== -->
