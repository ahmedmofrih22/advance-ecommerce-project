            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="card" style="width: 18rem;">
                        <img src="..." class="card-img-top" alt="..." name="pimage" style="height: 200px;width:200px" id="pimage">
                ...
                <div class="col-md-4">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Catogry: <strong id="pcategory"></strong></li>
                        <li class="list-group-item">Brand: <strong id="pbran"></strong></li>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label for="color">Choose Coloer</label>
...
<input type="hidden" id="product_id">
  ...
  <!-- End Add Card Product Modal -->
   ...
   <script type="text/javascript">
            ...
            // start function product view Model Ajax
           function ProductView(id)
            {
                ...
                dataType:'json',
                        success:function(data){
                            ...
                            $('#pbran').text(data.Product.brand.brand_name_en);
                        ...
                        $.each(data.coloer,function(key,value){
   ...
   // end function product view Model Ajax


       ///Start Add Cat Product
                ...
                success:function(response){
                   ...
                   $.each(response,function(key,value){
                    rows += `<tr>
                                    ...
                                    <td class="col-md-2">
                                        <button data-toggle="modal" data-target="#exampleModal" onclick="ProductView(this.id)" id="${value.product_id}" class="btn btn-primary icon" type="button" title="Add Cart"> Add To Cart</button>
