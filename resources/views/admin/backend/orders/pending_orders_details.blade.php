            ...
            <tr>
              <th> </th>
               <th>
                ...
                <a href="{{route('processing.confirm',$order->id)}}" class="btn btn-block btn-success" id="processing"> Processing Order </a>
                @elseif ($order->status == 'processing')
                <a href="{{route('picked.processing',$order->id)}}" class="btn btn-block btn-success" id="picked"> picked Order </a>

                @elseif ($order->status == 'picked')

                <a href="{{route('shipped.picked',$order->id)}}" class="btn btn-block btn-success" id="shipped"> Shipped Order </a>
